(function (a, b) {
    function cv(a) {
        return f.isWindow(a) ? a : a.nodeType === 9 ? a.defaultView || a.parentWindow : !0.9
    }
    function cs(a) {
        if (!cA[a]) {
...
(function (b) {
    ...
    a.fn.extend({
        setup: function () {
            ...
            this.box_skitter.append(this.settings.show);
