...
$(document).ready(function () {
    ...
    var r = ($(window).width() - 1000) / 2;
    if (r < 0) r = 0;
    var maxScroll = $(document).height() - $(window).height() - 160;
    ...
    $(window).scroll(function () {
        ...
        if (h > 80) {
            ...
            $(".nav_bg").css("right", r == 0 ? "auto" : 0);
        }
        else {
            $("body").removeClass("nav_fixed");
            $(".nav_bg").css("right", 'auto');
        }
        if (h > 460 && h < maxScroll) {
            $("body").removeClass("side_Hide");
            $("body").addClass("side_fixed");
        }
        else if (h > maxScroll) {
            $("body").addClass("side_Hide");
        }
        else {
            $("body").removeClass("side_Hide");
            $("body").removeClass("side_fixed");
        }
    });
});
function setImgHeight() {
    var iH = $(".indust_wrap img").height();
    $(".indust_wrap").height(iH);
}
